<div ng-controller="ResourceController" data-laravel-resource="App\Models\Position" data-laravel-stem="/admin/position/" class="margin-bottom" name="top">
  <div class="row">
    <div class="col-md-12">
      ...
      <h4 class="edit-header">
        [[ item.id ? 'Editing' : 'Creating' ]] Position: <span class="title" ng-class="{ untitled: !item.title }">"[[ item.title ? item.title : 'Untitled' ]]"</span>
        &nbsp;
      </h4>
    </div>
