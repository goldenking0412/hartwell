<div ng-controller="ResourceController" data-laravel-resource="App\Models\Product" data-laravel-stem="/admin/product/" class="margin-bottom" name="top">
  <div class="row">
    <div class="col-md-12">
      ...
      <h4 class="edit-header">
        [[ item.id ? 'Editing' : 'Creating' ]] Product: <span class="title" ng-class="{ untitled: !item.title }">"[[ item.title ? item.title : 'Untitled' ]]"</span>
        &nbsp;
      </h4>
    </div>
    ...
    <div class="col-md-3 edit-field">
      <label for="slug">Product Category</label>
      <select class="form-control" ng-model="item.product_category_id" ng-options="product_category.id as product_category.title for product_category in product_categories"></select>
    </div>
  </div>
