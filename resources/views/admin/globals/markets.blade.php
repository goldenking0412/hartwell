	...
	<div class="col-md-12">
		...
		<table class="table table-striped table-bordered">
			...
			<tbody sortable-parent="delta" autosave="true">
				<tr ng-controller="ResourceController" data-laravel-resource="App\Models\Market" ng-repeat="item in items" class="client-row" sortable-child>
					...
					<td class="col-md-2 hidden-xs img-cell-white">
						<div image-upload="item.image" directory="markets">
					...
					<td>
						<a class="btn btn-sm btn-warning" ng-href="/admin/markets/[[ item.id ]]">Edit</a>
						<a class="btn btn-sm btn-danger" ng-click="delete()" style="margin-top:10px;">Delete</a>
					</td>
				</tr>
				<tr ng-controller="ResourceController" data-laravel-resource="App\Models\Market" class="client-row">
					<td class="col-md-1"></td>
					<td class="col-md-5 col-xs-6">
						<div class="input-group">
							<input class="form-control" type="text" ng-model="item.title" placeholder="Market Name" />
							<div class="input-group-btn">
								<button class="btn btn-success" ng-click="save()" ng-class="{ disabled: !item.title }" type="button">Add Market</button>
							</div>
						</div>
					</td>
					<td class="col-md-5 col-xs-5">
