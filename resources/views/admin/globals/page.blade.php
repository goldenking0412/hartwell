<div ng-controller="ResourceController" data-laravel-resource="App\Models\Page" data-laravel-stem="/admin/page/" class="margin-bottom" name="top">
  <div class="row">
    <div class="col-md-12">
      ...
      <h4 class="edit-header">
        [[ item.id ? 'Editing' : 'Creating' ]] Page: <span class="title" ng-class="{ untitled: !item.title }">"[[ item.title ? item.title : 'Untitled' ]]"</span>
        &nbsp;
      </h4>
    </div>
  ...
  <?= View::make('admin.globals.meta') ?>

  <hr style="margin: 15px 0;"/>

  <div class="row" ng-show="item.type !== 'home'">
    <div class="col-md-12 edit-field">
      ...
      <ul class="list-unstyled" sortable-parent="delta">
        ...
        <li style="margin-top: 20px;" class="well edit-field clearfix" ng-controller="ResourceController" data-laravel-resource="Banner" new-child-with="page_id pushing [ 'headline', 'image', 'body' ] into $parent.item.banners">
          <div class="form-group">
            <label>Banner Headline</label>
            <input class="form-control" type="text" ng-model="item.headline" placeholder="Headline" />
          </div>
